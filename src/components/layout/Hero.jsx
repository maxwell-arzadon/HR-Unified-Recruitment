...
const categories = [
  "Social Media", "Programming", "Marketing",
  "Team Coach", "Non Voice Support", "SEO", "Billing",
];
          ...
          <div className="flex flex-col md:flex-row items-start justify-between gap-10">
            ...
            Your next career <br />
              ...
              <p className="text-white/70 text-sm md:text-base mb-8 max-w-md">
                Browse full-time, freelance, and language-based roles. Start your application today.
              </p>
              ...
              <div className="flex items-center gap-3 mb-10">
                <button
                    ...
                    style={{ background: "linear-gradient(90deg, #F13338, #F17F33)" }}
            ...
            {stats.map((s, i) => (
                <div key={s.label}>
                <div className={`font-jakarta font-bold ${s.color} text-5xl`}>{s.value}</div>
                <div className="text-white/60 text-sm mt-1 mb-4">{s.label}</div>
                {i < stats.length - 1 && <div className="border-t border-white/10 mb-4"/>}
                </div>
            ))}
            <div className="border-t border-white/10 pt-4">
                <p className="text-white/50 text-xs">Updated daily. Accepting applications now.</p>
            </div>
            </div>
