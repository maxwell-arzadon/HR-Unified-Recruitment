...
const hours = ["Less than 20 hrs","20-30 hrs","30-40 hrs","40+ hrs (Full Time)"];
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          {file ? (
            ...
            <>
              <p className="text-sm font-semibold text-black">Click to upload {label}</p>
...
export default function WorksTab() {
  ...
  return (
    <div>
      <h3 className="font-jakarta font-bold text-black text-base mb-1">Work Availability & Files</h3>
      <p className="text-sm text-zinc-400 mb-6">Upload required documents. Max file size: 5MB each.</p>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div>
          <label className="text-sm font-medium text-black mb-3 block">
            Available Work Hours per Week <span className="text-primary">*</span>
          </label>
        ...
        >
          <div className={`w-5 h-5 rounded border-2 flex items-center justify-center flex-shrink-0 mt-0.5 transition-all
            ...
            {isAdult && <Check size={11} weight="bold" className="text-white"/>}
          </div>
          <div>
            <p className="text-sm font-semibold text-black">
              I certify that I am at least 18 years old <span className="text-primary">*</span>
            </p>
            <p className="text-xs text-zinc-400 mt-0.5">
              By checking this, you confirm that you meet the minimum age requirement for employment
            </p>
          </div>
        </div>
