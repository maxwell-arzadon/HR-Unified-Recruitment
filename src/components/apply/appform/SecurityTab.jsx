...
export default function SecurityTab() {
  ...
  return (
    <div>
      <h3 className="font-jakarta font-bold text-black text-base mb-1">Security Information</h3>
      <p className="text-sm text-zinc-400 mb-6">This helps verify your identity if you need to recover your account.</p>
      ...
      <div className="flex flex-col gap-5">
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            ...
            <svg className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 pointer-events-none w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              <path d="M6 9l6 6 6-6"/>
            </svg>
          </div>
        ...
        <div>
          ...
          />
          <p className="text-xs text-zinc-400 mt-1">Keep this answer private. It is case-insensitive.</p>
        ...
        <div className="flex items-start gap-3 border border-success/30 bg-green-50 rounded-2xl px-5 py-4">
          ...
          <p className="text-sm text-zinc-600 leading-relaxed">
            Your information is secured and used solely for recruitment purposes, in compliance with our Privacy Notice and NDA
          </p>
        </div>
