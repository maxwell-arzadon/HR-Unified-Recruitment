...
const MIN_CHARS = 100;
const PROMPT    = "Describe a time when you had to handle a difficult customer or situation at work. What did you do, and what was the outcome?";
...
export default function EssayTest() {
  ...
  return (
    <>
      ...
      {showGuidelines && (
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-[9999]" />
            ...
            <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl p-8">
              <h2 className="font-jakarta font-bold text-black text-lg mb-6">Essay Guidelines</h2>
              ...
              <div className="border-t border-border pt-6 mb-6">
                ...
                <ol className="flex flex-col gap-2">
                  {[
                    ...
                    <li key={i} className="text-sm text-zinc-500">{i + 1}. {r}</li>
                  ))}
                </ol>
              </div>
              <button
      ...
      <h2 className="font-jakarta font-bold text-black text-lg mb-1">Essay Test</h2>
      <p className="text-sm text-zinc-400 mb-6">Write a thoughtful and detailed response. You have 25 minutes</p>

      {/* Prompt */}
      <div className="border border-border rounded-2xl p-5 mb-4">
        <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-2">Essay Prompt</p>
        <p className="text-sm font-semibold text-black leading-relaxed">{PROMPT}</p>
      </div>
