...
const tabs = ["Assessment Questions", "Grammar Test", "Typing Test", "Essay Test"];
...
export default function Step2Assessment({ onNext, onBack }) {
  ...
  const handleBack = () => {
    if (isTimerActive) { setShowWarning(true); return; }
          ...
          return (
            <div
              ...
              className={`flex items-center gap-2 px-4 py-4 text-sm font-semibold font-jakarta whitespace-nowrap border-b-2 -mb-px
                ...
                : isDone   ? "text-zinc-400 border-zinc-200"
