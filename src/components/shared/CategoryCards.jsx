        ...
        {categories.map(cat => (
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              <h3 className="font-jakarta font-bold text-black text-base">{cat.label}</h3>
              <p className="text-zinc-400 text-sm">{cat.desc}</p>
            </div>
            <div className="mt-auto">
              <span className={`${cat.badgeBg} ${cat.badgeColor} text-xs font-bold px-3 py-1 rounded-full`}>
                {cat.open} open
              </span>
            </div>
          </div>
